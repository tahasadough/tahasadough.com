...
export { default as ProfileLink } from './components/ui/profile-link.svelte';
...
export { default as SmoothScrollProvider } from './components/providers/smooth-scroll-provider.svelte';
